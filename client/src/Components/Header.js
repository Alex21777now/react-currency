          ...
          <Container>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav className="mr-auto">
                ...
                <Nav.Link href="/about"> Automatic </Nav.Link>
              ...
              <Form inline>
                ...
                <Button style={{ display: 'inline-block', marginRight: '3px' }}variant="warning mt-1" onClick={() => handleCardClick()}>Sign UP</Button>
                &emsp;
                <Button style={{ display: 'inline-block', marginRight: '3px' }}variant="danger mt-1" onClick={() => handleCardClick()}>Login</Button>
                </div>
